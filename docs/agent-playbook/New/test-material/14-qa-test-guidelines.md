...
- Dans le deroule des tours, chaque tour doit avoir un verdict `green`,
  `yellow` ou `red`.
...
- Les tool skills doivent respecter `New/runtime-contracts/00-architecture-doctrine.md` : comprehension par JSON IA, garde-fous deterministes legitimes, routing deterministe depuis sorties structurees.
