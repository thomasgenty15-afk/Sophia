...
const scope = `qa-active-flow-adjust-supersede-no-stop-${Date.now()}`;
const turns = [
  "Ajuste mon plan: reduis la marche du soir, elle est trop lourde et je veux une version plus simple.",
  "En fait programme plutot un rappel tous les soirs a 20h30 pour marcher.",
  "Oui cree le rappel.",
];
const results = [];
...
const outPath =
  `${root}/tests/real-personas/alex/runs/operations/2026-05-15-active-flow-adjust-supersede-no-stop-real.json`;
