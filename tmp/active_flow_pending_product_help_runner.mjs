...
const scope = `qa-active-flow-pending-question-${Date.now()}`;
const turns = [
  "Programme un rappel tous les soirs a 20h30 pour me rappeler de marcher.",
  "Petite question produit: ou est-ce que je retrouve les rappels dans l'interface ?",
  "Oui, cree le rappel.",
];
const results = [];
...
const outPath =
  `${root}/tests/real-personas/alex/runs/operations/2026-05-15-active-flow-pending-question-real.json`;
