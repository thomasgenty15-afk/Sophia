...
# ── UNE GÉNÉRATION, AVEC LA GARDE ANTI-DOUBLE-ÉCRITURE ────────────────────
# ⛔ SUR UN 502/504/000 ON NE REJOUE JAMAIS SANS AVOIR RELU LE COMPTE. Kong
# coupe la réponse, pas la fonction : insister écrit un second plan.
gen() {
