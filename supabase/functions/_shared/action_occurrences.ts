...
export function buildLightMorningInstruction(): string {
  return [
    ...
    "",
    "Exemples attendus:",
    '- Aucun contexte utile: "Je te souhaite une bonne journee. Garde juste un point d\'appui simple, et on avance."',
    "- Bonne dynamique recente: \"Je te souhaite une bonne journee. Garde l'elan d'hier, sans chercher a tout porter d'un coup.\"",
    '- Fatigue recente: "Je te souhaite une journee plus respirable. Aujourd\'hui, vise simple et concret."',
    "",
    "Exemples interdits:",
