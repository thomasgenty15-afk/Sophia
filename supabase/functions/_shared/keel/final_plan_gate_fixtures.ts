  ...
  nutrition: {
    ...
    days: HOUSEHOLD_ENERGY_ROWS.flatMap(({ memberId, breakfast, dinner, protein }) => [
      ...
      },
      {
        ...
        protein: { coveredFloorG: protein.floorMon, coveredCeilingG: null, reason: "applied_covered_window" },
        state: "conforme" as const,
      },
    ]),
  },
    ...
    days: [
      {
        ...
        proteinG: 21,
        proteinRoundingG: null,
        protein: { coveredFloorG: 20, coveredCeilingG: null, reason: "applied_covered_window" },
        state: "conforme",
      },
    ],
  },
