...
export interface ExtractionContext {
  ...
  user_profile?: {
     ...
     * `null` = inconnue -> le prompt retombe sur le français (comportement
     * historique de la branche FR, donc aucune régression).
     */
    locale?: string | null;
  } | null;
}
