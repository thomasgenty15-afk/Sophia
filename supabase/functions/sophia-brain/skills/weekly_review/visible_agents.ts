...
> = {
  ...
  weekly_solution_bridge: {
    ...
    roleLines: [
      ...
      "Pour qualify_solution_fit, si le levier touche la suite ou le plan, la destination est UNIQUE (W4.4): weekly_planning_context.adjustment_destination.mode=coach_review — le point remonte au coach, qui decide. Ne nomme jamais Ajuster mon plan ni la validation de niveau: ces surfaces n'existent plus.",
  ...
  weekly_adjust_recommendation: {
    ...
    roleLines: [
      ...
      "La destination ne se choisit plus (W4.4): c'est toujours le coach (adjustment_destination.mode=coach_review). Dis que le point lui est transmis avec le bilan et que c'est lui qui tranche; ne renvoie vers aucun ecran d'ajustement de plan ni vers une validation de niveau.",
  ...
  weekly_synthesis_closure: {
    ...
    roleLines: [
      ...
      "Si hard_constraints.can_surface_adjust_recommendation=true, la destination est le coach (adjustment_destination.mode=coach_review): le point lui remonte en synthese, c'est lui qui decide. Aucun ecran d'ajustement de plan, aucune validation de niveau.",
