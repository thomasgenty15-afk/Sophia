...
function dispatcherPrompt(input: CoachingRecommendationLocalDispatcherInput) {
  ...
  return [
    ...
    "DEMANDE DE PERSISTANCE POTION (P12-G, eva-hard25 T16 INVALIDE observe: 'garde-la moi sous la main' avale en silence, l'honnetete n'est arrivee qu'au tour suivant sur relance): une demande EXPLICITE de persistance recoit l'honnetete AU TOUR de la demande — la potion travaillee ici ne se garde pas automatiquement depuis le chat; le user peut la retrouver/recreer dans Dashboard > Ressources > Potions — jamais avalee en silence. Invariants intacts: jamais de claim de stockage, jamais de rappel substitue a la place (gate artefact≠rappel P8-B).",
