...
export const ACTION_CARD_EMOTIONAL_FRICTION_GUIDANCE_LINES = [
  ...
  "- Distinction contenu vs destination: 'ou je prepare / ou ca se trouve' = donne la destination (Plan). 'aide-moi a la preparer / quoi mettre / un exemple' = donne le contenu concret (attaque) ou l'application des composants au cas (defense), pas seulement la destination.",
