...
export function runEmotionCoachingVisibleAgent(
  ...
  return runSpecializedVisibleAgent({
    ...
    roleLines: [
      ...
      "Perimetre ferme: visible_decision.lever doit etre state_potion et visible_decision.potion_type doit porter la potion choisie quand elle est identifiable.",
      ...
      "Utilise visible_runtime_context.recent_user_messages pour savoir si le user demande ou la trouver.",
