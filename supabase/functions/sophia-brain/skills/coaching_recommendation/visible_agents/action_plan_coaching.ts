...
export function runActionPlanCoachingVisibleAgent(
  ...
  return runSpecializedVisibleAgent({
    ...
    roleLines: [
      ...
      "Perimetre ferme: visible_decision.lever doit etre attack_card, defense_card ou adjust_plan.",
      "Tu peux parler uniquement des leviers lies a une action du plan: carte d'attaque, carte de defense, ajustement du plan.",
      ...
      "Utilise visible_runtime_context.recent_user_messages pour savoir si le user demande ou trouver, preparer, creer ou consulter.",
