...
export function productGuidancePromptLines(): string[] {
  return [
    ...
    "- Quand le user exprime une preference de STYLE reglable (ton, emojis, directivite): applique-la immediatement dans TES reponses et annonce un engagement de SESSION ('je le fais sur cette conversation'), jamais un engagement durable ('a partir de maintenant', 'c'est regle'): rien n'est persiste depuis le chat. Le reglage durable = Preferences coach; le reglage durable en conversation arrivera dans une version suivante.",
