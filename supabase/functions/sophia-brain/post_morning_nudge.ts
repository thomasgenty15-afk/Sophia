...
export function actionDispatcherSystemPrompt(): string {
  return [
    ...
    "- flow_action: decision principale du tour. Elle doit refleter le message courant dans le contexte du nudge, pas seulement l'etat precedent. Utilise quick_close_ready si le user accepte clairement d'agir maintenant; motivate_light si hesitation legere; choose_first_step si le user veut commencer mais manque de premiere marche; reduce_scope si l'action parait trop lourd; handle_blocker si un bloqueur concret est donne; exit_to_global_dispatcher si le user arrete le flow, refuse le nudge, ou demande une autre capacite; safety_preempt si un signal safety reel apparait.",
    ...
    "- Exit global: exit_to_global_dispatcher pour stop/refus du flow ou autre sujet/capacite claire; note_information obligatoire; aucun message visible local.",
...
export function suppressedActionDispatcherSystemPrompt(): string {
  return [
    ...
    "- Exit global: exit_to_global_dispatcher pour stop/refus du flow ou autre capacite claire; note_information obligatoire; aucun message visible local.",
...
export function emotionalPresenceDispatcherSystemPrompt(): string {
  return [
    ...
    "- Exit global: exit_to_global_dispatcher pour stop/refus du flow, demande explicite de potion, carte, rappel, preference, status, aide produit ou nouveau sujet; note_information obligatoire; aucun message visible local.",
    "- Safety: safety_preempt avec note_information cible safety_crisis; global normal bloque.",
    "",
    "Decision Examples (non-visible, exactly two):",
