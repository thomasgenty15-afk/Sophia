...
const BASE_SIGNALS: DispatcherSignals = {
  ...
  track_progress_plan_item: { detected: false, status_hint: "unknown" },
  plan_item_discussion: { detected: false },
  plan_feedback: { detected: false, sentiment: "neutral" },
...
Deno.test("buildSurfaceRuntimeDecision: explicit dashboard intent suppresses unrelated opportunistic surface", () => {
  ...
  const signals: DispatcherSignals = {
    ...BASE_SIGNALS,
    plan_item_discussion: { detected: true, item_hint: "course du matin" },
  };
