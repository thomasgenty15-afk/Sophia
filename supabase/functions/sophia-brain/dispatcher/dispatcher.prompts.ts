...
- Ne mets pas dans note_information: source_flow_presentation, source_flow_state_summary, target_local_dispatcher_hint, risk_score, preuve DB ou preuve d'effet. Ces informations appartiennent aux traces/runtime ou a structured_context si elles sont semantiques.
...
- demotivation_repair possede aussi les boucles d'evitement motivationnel: le user repousse une action qu'il veut garder parce qu'elle implique peur du regard, conflit, inconfort, exposition ou passage intimidant. Structure ce cas comme famille avoidance_loop / besoin durable courage_through_avoidance dans evidence ou structured_context; ne le transforme pas en normal_reply, adjust_plan_item ou rappel.
...
- Si le user dit qu'il veut garder le plan, tenir la direction, conserver l'action, ou ne pas modifier l'organisation, cette contrainte bloque adjust_plan_item sauf demande explicite contraire de modification. Le besoin peut rester demotivation_repair, prepare_attack_card ou conversation normale selon l'intention.
...
- create_one_shot_reminder:
  ...
  - Un besoin d'appui, soutien, support, présence ou coup de pouce sans demande explicite d'être rappelé/notifié/programmé et sans moment/delai n'est jamais create_one_shot_reminder. Laisse le skill humain, product_help ou normal_reply porter le tour selon le contexte.
