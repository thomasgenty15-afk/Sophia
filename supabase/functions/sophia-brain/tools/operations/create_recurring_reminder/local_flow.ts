...
function defaultVisibleTask(
  ...
  return {
    ...
    conversation_context: {
      ...
      active_flow_summary:
        "Préparer un rappel récurrent à reprendre dans la surface Initiatives, sans création depuis le chat.",
      collected_state: {
...
export function buildCreateRecurringReminderLocalDispatcherSystemPrompt(): string {
  return [
    ...
    "Le chat ne peut pas créer de rappel récurrent; le succès nominal V1 est un handoff plateforme vers la surface Initiatives.",
