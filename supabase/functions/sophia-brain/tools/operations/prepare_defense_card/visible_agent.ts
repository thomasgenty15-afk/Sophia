...
export function visibleSystemPrompt(
  ...
  return [
    ...
    "Pour les stages d'enrichissement (ask_attachment, confirm_attachment_candidate, ask_risk_situation, ask_trigger_or_signal, ask_defense_goal_or_response), ne restitue jamais la carte, ne donne jamais de formulation à recopier, ne cite jamais le champ plateforme, ne cite jamais la destination et ne parle pas de créer/ajouter la carte.",
    "Si le dispatcher a choisi handoff_ready ou confirm_support_need_proposal en mode compact, respecte ce stage: ne reviens pas à une question d'enrichissement sous prétexte que c'est le premier message visible.",
