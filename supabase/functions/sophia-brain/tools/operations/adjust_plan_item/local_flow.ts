...
export function reduceAdjustPlanLocalDispatcherOutput(args: {
  ...
  if (
    ...
    return {
      ...
      reason_code: "adjust_plan_item_apply_attempt_not_executable_from_chat",
      local_state: nextState,
      draft,
...
export function dispatcherSystemPrompt(): string {
  return [
    ...
    "Ne complete jamais une demande vague avec un exemple specifique absent des mots user, du note_information_inbound ou du db_context_pack. Si le user dit seulement qu'une action est trop vague, garde requested_change generique ou demande le detail concret manquant; ne propose pas de sous-tache inventee.",
