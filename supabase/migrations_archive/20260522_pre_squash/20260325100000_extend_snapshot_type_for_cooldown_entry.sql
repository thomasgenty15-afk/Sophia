...
-- to accept 'cooldown_entry' for the configurable cooldown engine (Phase A).
--
-- Additive: preserves all existing values and adds 'cooldown_entry'.
-- Ref: v2-execution-playbook.md Phase A, cooldown_engine.ts
