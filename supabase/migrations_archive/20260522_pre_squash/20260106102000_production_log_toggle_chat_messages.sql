-- Add a toggle to include/exclude chat_messages from the Admin production log.
-- Rationale: chat_messages can be extremely noisy; the admin timeline is more useful when it highlights
-- system events (checkins/whatsapp pending actions/stripe/llm/errors) by default.
