-- Cleanup V1 user_profile_facts model and ensure dashboard is the single
-- source of truth for coach preferences.

-- 1) Stop and remove V1 candidate-expiry cron/function (table already dropped).
...
-- 2) Remove watcher-era facts (old schema keys).
