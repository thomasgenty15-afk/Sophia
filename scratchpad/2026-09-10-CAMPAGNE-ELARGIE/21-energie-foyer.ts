...
console.log(JSON.stringify({
  ...
  // ⟳ 2026-09-10 — LA CIBLE PAR BOUCHE, EXPOSÉE. La version d'origine n'en
  // rendait que la SOMME (`somme_cibles_kcal`), ce qui ne permet pas de dire
  // « cette bouche-là est à ±5 % de SA cible » — le critère d'acceptation du
  // chantier. `cibles` vient de `mouthTargetKcal` (production), pas d'un calcul
  // refait ici.
  cibles: cibles.map((c) => ({
    name: c.name,
