...
| 2026-06-08 | Ajouter `09-note-information-contract.md` comme contrat transverse pour tous les changements de dispatcher et les changements de dispatcher documentés. | Active | Note information transverse |
