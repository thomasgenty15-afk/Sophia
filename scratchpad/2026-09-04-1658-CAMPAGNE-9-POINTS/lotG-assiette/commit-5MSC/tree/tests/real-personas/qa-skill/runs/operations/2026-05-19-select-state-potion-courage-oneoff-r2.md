...
- Date: 2026-05-19
- Run: `2026-05-19-select-state-potion-courage-oneoff-r2`
- Persona: `qa-skill`, connexion locale temporaire reutilisee depuis `2026-05-19-select-state-potion-courage-oneoff-r1`
- Objectif: relancer le scenario courage ponctuel apres indication que le runtime devait etre revenu a la normale.
...
- Raw: `tests/real-personas/qa-skill/runs/operations/2026-05-19-select-state-potion-courage-oneoff-r2.raw.json`
- Summary: `tests/real-personas/qa-skill/runs/operations/2026-05-19-select-state-potion-courage-oneoff-r2.summary.json`
- Durable: `tests/real-personas/qa-skill/runs/operations/2026-05-19-select-state-potion-courage-oneoff-r2.durable.json`
...
**Problemes**
- Le runtime retourne `504` avant le router Sophia. Impact systeme: run invalide pour verifier le planner one-shot courage.
