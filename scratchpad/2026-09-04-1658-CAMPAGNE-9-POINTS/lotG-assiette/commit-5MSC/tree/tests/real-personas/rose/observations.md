...
Document autonome pour piloter le rodage de Rose. Ajouter ici les observations,
corrections, bugs, choses a retester et decisions de test.

## Cadre

But du lab Rose : a completer quand son objectif et son plan actif seront
documentes.

Rose doit rester un test realiste : l'agent QA peut varier les messages, mais
...
- contexte : creation du dossier real-persona Rose.
...
- preuve : `tests/real-personas/rose/`.
- statut : decision.
...
- 2026-05-12 : creation du dossier Rose.
