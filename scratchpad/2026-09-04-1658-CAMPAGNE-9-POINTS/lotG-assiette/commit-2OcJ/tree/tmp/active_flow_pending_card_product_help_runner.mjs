...
const scope = `qa-active-flow-pending-card-question-${Date.now()}`;
const turns = [
...
const outPath =
  `${root}/tests/real-personas/alex/runs/operations/2026-05-15-active-flow-pending-card-question-real.json`;
