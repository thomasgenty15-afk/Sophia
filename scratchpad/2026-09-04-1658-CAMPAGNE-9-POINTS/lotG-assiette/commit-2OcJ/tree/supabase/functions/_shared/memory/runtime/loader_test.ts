...
// RETRAIT RÉSIDUS (2026-08-08): le test « action memories by exact plan
// item » est parti avec les signaux de plan (user_plan_items supprimée);
// loadActiveActionSignals rend [] depuis le même retrait.
