...
-- to accept all V2 event types emitted by Lot 3+ (plan generation,
-- activation, lifecycle events, runtime, memory, coaching).
--
-- This is additive: the 5 original values are preserved.
-- Ref: v2-events.ts V2_EVENT_TYPES, playbook Lot 2.2 decision note.
