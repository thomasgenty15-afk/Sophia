-- Schedule trigger-global-memory-compaction to compact and embed global memories
-- outside the main memorizer pipeline.
...
begin
  ...
  from cron.job
  where jobname = 'trigger-global-memory-compaction'
  limit 1;
...
select cron.schedule(
  ...
  select
    net.http_post(
      url := (select base_url from cfg) || '/functions/v1/trigger-global-memory-compaction',
