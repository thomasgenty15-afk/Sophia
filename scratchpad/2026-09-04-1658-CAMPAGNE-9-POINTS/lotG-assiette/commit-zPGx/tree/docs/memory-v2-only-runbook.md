...
- Topic V1 columns: `synthesis`, `synthesis_embedding`, `mention_count`, `enrichment_count`, `first_mentioned_at`, `last_enriched_at`, `last_retrieved_at`, `summary_compacted_at`, `pending_enrichment_count`, `pending_enrichment_chars`, `title_embedding`
- RPCs: `match_topic_memories_by_keywords`, `match_topic_memories_by_synthesis`, `match_topic_memories_by_title`, `match_global_memories`, `match_event_memories`, `match_memories_for_user`, `match_memories`
