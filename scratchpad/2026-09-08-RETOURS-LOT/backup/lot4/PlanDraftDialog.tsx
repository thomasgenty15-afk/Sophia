...
export interface PlanDraftDialogProps {
  ...
  draftId: string | null;
  /**
   * ⟳ 2026-09-08 — CE QUE LA PHRASE A FAIT, rendu SOUS LE CHAMP.
   * ⛔ REQUIS, jamais `?`: les deux sites de montage doivent le passer — un
   * champ facultatif aurait laissé l'un des deux muet sans que personne le voie.
   */
    ...
    >
      ...
      <div className="mt-6 border-t border-line pt-4">
        ...
        {noteOutcome !== null && noteOutcome.announced.length > 0
          ...
          : null}
        {noteOutcome !== null && noteOutcome.announced.length === 0 && noteOutcome.whoUnknown > 0
          ? (
            <p className="mt-2 text-sm leading-6 text-ink">
