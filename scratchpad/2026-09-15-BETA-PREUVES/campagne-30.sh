...
TABLE="$S/campagne-30.tsv"; echo -e "n\tprofil\tcompte\thttp\tduree_ms\tappels\treparations\tverrou\tsortie" > "$TABLE"
n=0; ordre=()
...
PY
  ...
  if [ "$http" != "200" ]; then echo "⛔ ARRÊT : HTTP $http"; break; fi
