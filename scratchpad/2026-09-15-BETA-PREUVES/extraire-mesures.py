...
M="scratchpad/2026-09-15-BETA-PREUVES/mesure"; FX="scratchpad/2026-09-11-CLOTURE/fixtures"; SO="scratchpad/2026-09-11-FIABILITE-RECETTES/sorties-lot-F"
TIRS=sys.argv[1:] or ["7","9","8","1","2","5","6","10"]
...
for n in TIRS:
    ...
    g=json.load(open(f"{FX}/tir{n}-b15-c0.json")); dem=g["demande"]; le=g.get("ligne_ecrite") or {}
    ...
    out.append({"tir":n,"titre":g.get("titre"),"request_id":g.get("request_id"),"bouches_n":len(dem.get("bouches") or []),
        ...
        "bouches":bouches})
json.dump(out,open("scratchpad/2026-09-15-BETA-PREUVES/mesures-2026-09-15.json","w"),ensure_ascii=False,indent=2)
