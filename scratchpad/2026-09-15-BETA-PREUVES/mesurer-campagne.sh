#!/usr/bin/env bash
# LA MESURE DES 30 — fige chaque artefact (demande, roster, échanges, journal archivé),
...
TABLE="${1:-/private/tmp/claude-502/campagne-30/campagne-30.tsv}"
M=scratchpad/2026-09-15-BETA-PREUVES/mesure-30; mkdir -p "$M"
