...
const scope = "qa-flow-normal-exec-emotion-15t-2026-05-06";
...
const rawPath = path.join(runDir, "2026-05-06-normal-exec-emotion-15t.raw.json");
const summaryPath = path.join(
  runDir,
  "2026-05-06-normal-exec-emotion-15t.summary.json",
);
const history = [];
const raw = [];
const summary = [];
...
for (let i = 0; i < messages.length; i += 1) {
  ...
  const requestId = `qa-normal-exec-emotion-15t-2026-05-06-t${
