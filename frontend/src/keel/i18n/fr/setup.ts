...
export const frSetup = {
  ...
  "setup.situate.title": "Tu cuisines pour combien de personnes ?",
  ...
  "setup.traditions.hint":
    "Le rôti du dimanche, le poisson du vendredi. Dis-le et le plan compose autour, au lieu de composer par-dessus. Deux ou trois suffisent — trois au maximum.",
  ...
  "setup.traditions.label": "C'est quoi, dans tes mots",
  ...
  "setup.traditions.full":
    "Trois, c'est le maximum. Retires-en un pour en ajouter un autre.",
  ...
  "setup.people.diet": "Comment tu manges",
  ...
  "setup.mouths.first_name_hint_you": "C'est ainsi que le plan nommera ta part.",
  ...
  "setup.mouths.allergies_you": "Tu es allergique à quelque chose ?",
  ...
  "setup.mouths.branch_full":
    "Le nombre de personnes choisi à la première étape est déjà atteint. Reviens à cette étape pour le modifier.",
  ...
  "setup.equipment.hint": "Coche ce que tu as vraiment. Un congélateur décide si on peut cuisiner une fois et garder le reste ; un micro-ondes décide de ce que « à réchauffer » veut dire le jour même.",
  ...
  "setup.equipment.error_empty":
    "Coches-en au moins un — sans aucun des sept, il n’y a rien pour cuisiner. " +
    "Si tu préfères ne rien dire, laisse la ligne telle quelle.",
  "setup.equipment.loading": "Lecture de ce que tu as déjà dit…",
  "setup.equipment.no_goal":
    "Renseigne d’abord ton objectif au-dessus, ensuite ceci pourra être enregistré.",
  ...
  "setup.missing.own_diet":
    "Comment tu manges — « je mange de tout » est une réponse. Sans ça, un plan " +
    "entier peut être inutilisable dès le premier soir.",
  "setup.missing.own_allergies": "Si tu as des allergies — « aucune » compte comme une réponse.",
  ...
  "setup.missing.cooking_time_min": "Combien de temps peut durer une session de cuisine.",
