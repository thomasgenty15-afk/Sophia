...
// `MouthRowSummary.tsx`. Ce fichier garde la page elle-même, le refus d'un
// générateur et la semence de ma fiche. Il RÉ-EXPORTE les étapes qu'il
// exportait: les imports de `App.tsx` et des tests ne changent pas. Les modules
// font partie de la famille de ce fichier (`scripts/source-families.json`), que
// les tests lisent à la place du fichier seul.
...
import { goalLabel, occasionLabel } from "./setup/labels.ts";
