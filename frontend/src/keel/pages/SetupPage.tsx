...
// `MouthRowSummary.tsx`, `TableStep.tsx`, `RequestStep.tsx`, `MissCards.tsx`.
// Ce fichier garde la page elle-même, le refus d'un générateur et la semence de
// ma fiche. Il RÉ-EXPORTE les étapes qu'il exportait: les imports de `App.tsx`
// et des tests ne changent pas. Les modules font partie de la famille de ce
// fichier (`scripts/source-families.json`), que les tests lisent à la place du
// fichier seul.
import type { Load, SelfDraft } from "./setup/types.ts";
import { type MouthDraft, mouthDraftHasContent, emptyMouthDraft } from "./setup/mouthDraft.ts";
import { goalLabel } from "./setup/labels.ts";
...
import { MouthRowSummary } from "./setup/MouthRowSummary.tsx";
