...
const PREFERENCES: PreferenceDef[] = [
  ...
  },
  {
    ...
    description: 'Définit si Sophia relance souvent avec des questions ou si elle va plus directement au point.',
    defaultValue: 'normal',
    options: [
      { value: 'low', title: 'Peu de questions', description: 'Sophia va plus souvent droit au point sans relancer.' },
      { value: 'normal', title: 'Équilibré', description: 'Un bon niveau de relance pour clarifier sans alourdir.' },
      { value: 'high', title: 'Très questionnant', description: 'Sophia explore davantage avec plus de questions.' },
    ],
  },
];
    ...
    <section className="mb-10">
      ...
      <div className="mb-6 bg-gradient-to-br from-violet-50 to-white border border-violet-100 rounded-2xl p-5 shadow-sm relative overflow-hidden">
        <div className="absolute top-0 right-0 p-3 opacity-10">
            <Mic2 className="w-24 h-24 text-violet-600 rotate-12" />
        </div>
