...
(ex : un livre = transmettre ta vision, une entreprise = créer des solutions, une famille = prolonger l’amour, une œuvre = inspirer…)

• Quelles valeurs ou idées tu veux voir continuer à travers cet héritage ?
• Complète :
...
(ou les 1 à 2 plus importantes)

• À quoi ressemblerait la première pierre de cet héritage ?

(ex : écrire un premier chapitre, lancer une première version, enregistrer une œuvre, créer un rituel familial, poser les bases d’un projet…)
...
(systèmes, routines, collaborations, argent, compétences, temps réservé…)

• Quelles habitudes ou engagements récurrents peux-tu mettre en place

pour avancer régulièrement sur ton héritage (hebdo / mensuel) ?
...
• Complète ces phrases :
    ...
    • ‘Je veux que, même quand je dormirai, mon travail continue à…’
• Si tu devais expliquer à un enfant ce que tu es en train de construire pour le futur,
...
clarté, calme, énergie, conflit, lucidité, pression, douceur, humour, structure… ?
...
ex : plus courageux, plus apaisés, plus lucides, plus alignés, plus libres, plus motivés…

• Note 3 à 5 phrases commençant par :
    • ‘J’aimerais que les gens repartent de moi en se sentant…’
    • ‘Mon impact humain idéal, ce serait que…’
• Puis choisis 1 à 3 interactions concrètes à venir
...
que quelque chose avait vraiment bougé chez l’autre ?

• Quels types d’échanges te semblent les plus ‘féconds’
...
‘je vois comment ça change les gens’.

Ça renforce ta légitimité et ta responsabilité.`
      },
      {
        levelId: 5,
...
• Complète ces phrases :
    ...
    • ‘Ma manière unique de transformer les autres, c’est…’
• Si tu devais expliquer à quelqu’un

en quoi sa vie pourrait être différente après avoir travaillé avec toi,
...
• À quoi ressemble la toute première version de ce projet ?

(prototype, brouillon, V1 imparfaite)

• Quelles 1 à 3 actions concrètes peux-tu poser dans les 7 à 30 prochains jours
...
(compétences, alliés, argent, discipline, systèmes, pauses…)
...
• Complète ces phrases :
    ...
    • ‘Je m’engage à lui donner une place réelle dans ma vie en…’
• Si tu devais expliquer à quelqu’un que tu aimes

pourquoi ce projet compte autant pour toi,
...
C’est ce serment qui transforme un projet en œuvre de vie.`
      }
    ]
  }
};
