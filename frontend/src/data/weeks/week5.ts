...
(ex : justice, liberté, dignité, vérité, authenticité, éducation, respect…)
...
• Complète ces phrases :
    ...
    - ‘Je veux contribuer, à mon échelle, à un monde où…’
• Si tu devais expliquer à quelqu’un

‘voilà l’ennemi que j’ai choisi d’affronter dans ma vie’,
...
(ex : tu apaises, tu clarifies, tu motives, tu organises, tu inspires, tu resserres les liens…)
...
(ex : dans ton job, sur un projet perso, dans ton contenu, avec des proches…)

– Note 1 à 3 actions précises où tu vas délibérément utiliser ton don :
...
– Si quelqu’un devait décrire ta manière unique de faire les choses,
...
‘Mon super-pouvoir, c’est ______, et je l’utilise pour ______.’

– Comment veux-tu l’exploiter davantage dans les prochaines années ?

(dans ton travail, tes projets, ton contenu, tes relations…)
...
• Laquelle est la plus alignée avec :
    ...
    - l’ennemi à abattre que tu as identifié
...
(ex : éduquer, créer des outils, accompagner, entreprendre, financer, sensibiliser, inspirer, organiser, réparer…)

• Quels formats t’inspirent le plus ?
...
(ce que tu pourrais construire en 3 ans, 5 ans, 10 ans…)
...
Tu passes de “rêve flou” à “projet de vie”.`
      },
      {
        levelId: 5,
