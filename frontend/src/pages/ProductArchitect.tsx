      ...
      <main className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 mb-32">
          <div className="flex items-center justify-center gap-3 mb-12">
            ...
            <h2 className="text-lg font-bold text-emerald-400 uppercase tracking-widest text-center">Niveau de plan 1 : Construction du Temple</h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6 mb-32">
          <div className="flex items-center justify-center gap-3 mb-12">
            ...
            <h2 className="text-lg font-bold text-emerald-400 uppercase tracking-widest text-center">Niveau de plan 2 : Amélioration du Temple</h2>
          </div>
