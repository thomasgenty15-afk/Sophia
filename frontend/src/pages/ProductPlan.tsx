    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-violet-100 selection:text-violet-900">
      ...
      <main className="pt-32 pb-20">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center mb-24">
            <button onClick={() => navigate('/')} className="inline-flex items-center gap-2 text-slate-500 hover:text-violet-600 mb-8 transition-colors font-medium text-sm">
        ...
        <div className="max-w-6xl mx-auto px-6 mb-24">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* FEATURE 1: CLARTÉ */}
                <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-violet-200 transition-all group">
                    <div className="w-14 h-14 bg-violet-50 rounded-2xl flex items-center justify-center text-violet-600 mb-6 group-hover:scale-110 transition-transform">
                        <Target className="w-7 h-7" />
                    </div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-4">1. Clarté Immédiate</h3>
                ...
                <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-emerald-100/50 border border-slate-100 hover:border-emerald-200 transition-all group">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-4">2. Le Moteur WhatsApp</h3>
                    <p className="text-slate-600 leading-relaxed text-lg">
                ...
                {/* FEATURE 3 */}
                <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-amber-100/50 border border-slate-100 hover:border-amber-200 transition-all group">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-4">3. Adaptation Continue</h3>
                    <p className="text-slate-600 leading-relaxed text-lg">
                ...
                {/* FEATURE 4 */}
                <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-indigo-100/50 border border-slate-100 hover:border-indigo-200 transition-all group">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-4">4. Le Grimoire</h3>
                    <p className="text-slate-600 leading-relaxed text-lg">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 md:p-12 shadow-2xl text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Au-delà de la simple productivité</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div>
                            ...
                            <h3 className="text-lg font-bold mb-2">Hypnoses Fondamentales</h3>
                        ...
                        <div>
                            <div className="w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center text-violet-400 mb-4">
                                <Brain className="w-6 h-6" />
                            </div>
                            <h3 className="text-lg font-bold mb-2">Hypnose Sur-Mesure</h3>
                            <p className="text-slate-400 text-sm leading-relaxed">
                        ...
                        <div>
                            <div className="w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center text-amber-400 mb-4">
                                <Shield className="w-6 h-6" />
                            </div>
                            <h3 className="text-lg font-bold mb-2">Présence Gardienne 24/7</h3>
                            <p className="text-slate-400 text-sm leading-relaxed">
